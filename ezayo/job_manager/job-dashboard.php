<div id="job-manager-job-dashboard">
	<p><?php _e( 'Your job listings are shown in the table below. When a job is no longer available, please mark it as filled (if you’ll be duplicating it in the future) or delete it.', 'wp-job-manager' ); ?></p>
	<table class="job-manager-jobs uk-table uk-table-hover uk-table-striped">
		<thead>
			<tr>
